...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="max-w-5xl mx-auto px-4 py-6">
        ...
        <div class="mb-5 flex items-center justify-between">
            ...
            <button onclick="document.getElementById('modal-nuevo').classList.remove('hidden')" class="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white
        ...
        <form method="GET" class="mb-4 flex gap-2">
            <input type="text" name="q" value="<?= htmlspecialchars($buscar) ?>"
                placeholder="Buscar por nombre, empresa o RFC..." class="flex-1 border border-gray-200 rounded-lg px-4 py-2 text-sm
            ...
            <?php if ($buscar): ?>
                <a href="clientes.php" class="px-3 py-2 text-sm text-gray-400 hover:text-gray-600">Limpiar</a>
            <?php endif; ?>
        </form>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-100">
                        ...
                        <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                            Empresa</th>
                        <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">RFC
                        </th>
                        <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                            Email</th>
                        <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">
            ...
            <form method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" name="rfc" maxlength="20" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm
                    ...
                    <div>
                        ...
                        <input type="tel" name="telefono" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm
                                      focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="10 dígitos">
                    </div>
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-600 mb-1">Email</label>
                    <input type="email" name="email" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm
                                  focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <button type="submit" class="flex-1 bg-blue-900 hover:bg-blue-800 text-white font-semibold py-2
