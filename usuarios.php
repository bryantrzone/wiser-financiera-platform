...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <button id="btn-nuevo-usuario" class="flex items-center space-x-2 px-5 py-2.5 bg-accent text-white
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm mb-5 p-4">
            <div class="flex flex-col sm:flex-row gap-3">
                <div class="relative flex-1">
                    ...
                    <input type="text" id="buscar-usuario" placeholder="Buscar por nombre o correo…" class="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50">
                            <th
                                class="text-left px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                                Usuario</th>
                            <th
                                class="text-left px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                                Correo</th>
                            <th
                                class="text-left px-4 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                                Rol</th>
                            <th
                                class="text-left px-4 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                                Estado</th>
                            <th
                                ...
                                Último acceso</th>
                            <th
                                class="text-right px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                                Acciones</th>
                        </tr>
                    </thead>
            ...
            <form id="form-usuario" class="px-6 py-5 space-y-4" novalidate>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" id="modal-full-name" class="wf-input" placeholder="Nombre y apellidos"
                            required>
                    </div>
                    <div class="sm:col-span-2">
                    ...
                    <div>
                        <label class="wf-label">Contraseña <span id="lbl-pass-hint"
                                class="text-gray-400 font-normal">(requerida)</span></label>
                        <div class="relative">
                            <input type="password" id="modal-password" class="wf-input pr-10"
                ...
                <!-- Error del modal -->
                <div id="modal-error"
                    class="hidden p-3 bg-red-50 border border-red-200 rounded-xl text-sm text-red-700"></div>

                <!-- Botones -->
                <div class="flex space-x-3 pt-2">
                    <button type="button" id="modal-cancelar" class="flex-1 py-2.5 border border-gray-200 rounded-xl text-sm font-medium
                               text-gray-600 hover:bg-gray-50 transition-colors">
                        Cancelar
                    </button>
                    <button type="submit" id="modal-guardar" class="flex-1 py-2.5 bg-accent text-white rounded-xl text-sm font-semibold
