    ...
    <div class="absolute left-0 top-0 h-full w-72 max-w-[88vw] bg-white shadow-xl flex flex-col
        ...
        <div class="flex items-center justify-between px-4 py-3.5 border-b bg-gray-50">
            ...
            <button id="cerrar-menu"
                    class="p-1.5 rounded-lg text-gray-400 hover:bg-gray-200 transition-colors">
        ...
        <nav class="flex-1 overflow-y-auto p-2 space-y-0.5">
            ...
            <!-- Cotizaciones -->
            <button id="menu-mis-cotizaciones"
                    class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors
                           <?= _navCls('cotizaciones', $currentPage) ?>">
                <i data-lucide="files" class="w-4 h-4 shrink-0 text-gray-400"
                   aria-hidden="true"></i>
                <div class="text-left">
            ...
            <button id="menu-usuarios"
                ...
                <i data-lucide="settings" class="w-4 h-4 shrink-0 text-gray-400"
                   aria-hidden="true"></i>
                <div class="text-left">
            ...
            <button id="menu-catalogos"
                    class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors
                           <?= _navCls('catalogos', $currentPage) ?>">
                <i data-lucide="layers" class="w-4 h-4 shrink-0 text-gray-400"
                   aria-hidden="true"></i>
                <div class="text-left">
...
(function () {
    ...
    _nav('menu-nueva-cotizacion', '/wiser-financiera-project/index.php');
    _nav('menu-mis-cotizaciones',  '/wiser-financiera-project/cotizaciones.php');
    _nav('menu-usuarios',          '/wiser-financiera-project/usuarios.php');
    _nav('menu-catalogos',         '/wiser-financiera-project/catalogos.php');

    _bind('menu-logout', function () {
        _close();
        setTimeout(function () { window.location.href = '/wiser-financiera-project/logout.php'; }, 50);
    });
})();
</script>
